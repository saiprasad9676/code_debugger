    ...
    useGSAP(
        () => {
            ...
            const build = () => {
                ...
                // Note: GSAP SplitText is a Club GreenSock perk. 
                // If you don't have it, this will fail or need a trial version/alternative.
                // Assuming the user has access or is using a trial/compatible version as they provided the code.
                // However, standard GSAP package does NOT include SplitText. 
                // If this fails, we might need a different approach or the user needs the paid plugin.
                // For now, I will proceed as requested.
                ...
                try {
                    splitRef.current = new GSAPSplitText(el, {
                        ...
                        // smartWrap: true, // smartWrap might not be in all versions or requires specific setup
                        // reduceWhiteSpace: false
                    });
                } catch (e) {
                    console.warn("GSAP SplitText might not be available. Animation may not work as expected.", e);
                    return;
                }
